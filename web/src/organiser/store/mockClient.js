  ...
  tasks: [
    {
      ...
      updates:
        [{"id": "9", "text": "Update 1", "date": "2025-02-10"}, {"id": "10 ", "text": "Update 2", "date": "2025-02-11"}],
      dueDate: "2025-02-10",
      forWho: "Alice",
    ...
    },
    {
      ...
      description: "Draw up design for X",
      updates: [{"id": "1", "text": "Fix the bug", "date": "2025-02-10"},
        {"id": "2", "text": "Fix the bug again", "date": "2025-02-10"}
      ],
      dueDate: "",
      forWho: "",
      refs: [],
    ...
    },
    {
      ...
      description: "Draw up design for Y",
      updates: [{"id": "3", "text": "Fix the bug", "date": "2025-02-10"}],
      dueDate: "2025-02-13",
      forWho: "Alice",
      refs: ["https://jira.com/task123"],
      status: "in_progress",
    },
    {
      ...
      description: "Fix routing for project Z",
      updates: [{"id": "4", "text": "Fix the bug", "date": "2025-02-10"}],
      dueDate: "2025-02-27",
      forWho: "David",
      refs: [],
      status: "todo",
    },
    {
      ...
      updates: [{"id": "5", "text": "Fix the bug", "date": "2025-02-10"}],
      dueDate: "2025-03-06",
      forWho: "Charlie",
      refs: ["https://jira.com/task123"],
      status: "blocked",
    },
    {
      ...
      description: "Raise change ticket for thingy",
      updates: [{"id": "6", "text": "Fix the bug", "date": "2025-02-10"}],
      dueDate: "2025-02-10",
      forWho: "Alice",
      refs: ["https://jira.com/task123"],
      status: "in_progress",
